...
map = Map(map_file)
car = Car(map)
agent = DQNAgent(param_dict, training=True, load_path='save/final_10.pth')
agent.model.train()
...
step_tot, score_tot, max_score = 0, 0.0, 3000 #-float('inf')
...
while not end:
    ...
    while not done:
        ...
        reward = reward_policy.give_reward(car.x, car.y, action, done)
